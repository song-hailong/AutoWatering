...
char auth[] = "d83bbd09e9eb";  // Your Device Secret Key
char ssid[] = "405_OpenWrt";  // Your WiFi network SSID or name       360WiFi-123456
char pswd[] = "405405405";  // Your WiFi network WPA password or WEP key    zpteam123456 
...
void heartbeat()
{
  ...
  sprintf(SprintfChar, "系统运行时间: %ld时%ld分 ", run_time/3600, run_time%3600/60);
